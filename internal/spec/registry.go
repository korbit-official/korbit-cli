...
var Registry = []Command{
	...
	},
	{
		...
		Notes: []string{
			...
			"Interactive and full-screen — needs a real terminal (TTY). It is built for humans; agents should use `dgx-cli monitor` (--json is rejected here, except with --dry-run).",
