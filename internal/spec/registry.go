...
var Registry = []Command{
	...
	},
	{
		...
		Notes: []string{
			"Most users never need this — the default endpoint is correct unless your account has been provisioned on a different Korbit API host. The command line (--base-url) and the DIGITALX_CLI_BASE_URL env var still override a key's stored URL.",
